module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, msg_ask = nil, msg_schedule_1 = nil, msg_schedule_2 = nil, msg_schedule_3 = nil, msg_custom_type = nil,  sanitize_text=true, attachment=nil, message_timestamp = Time.now)
        convo = Mailboxer::Conversation.new({:subject => subject})
        convo.created_at = message_timestamp
        convo.updated_at = message_timestamp
        message = messages.new({:body => msg_body, :subject => subject, :ask => msg_ask, :schedule_1 => msg_schedule_1, :schedule_2 => msg_schedule_2, :schedule_3 => msg_schedule_3, :custom_type => msg_custom_type, :attachment => attachment})
